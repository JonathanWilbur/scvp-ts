...
} from "ocsp-ts/dist/node/OCSP-2013-08";
import { id_sha1 } from "x500-ts/dist/node/AlgorithmObjectIdentifiers";
import {
...
let _cached_decoder_for_NameValidationAlgParams: __utils.ASN1Decoder<
    NameValidationAlgParams
> | null = null;
let _cached_encoder_for_NameValidationAlgParams: __utils.ASN1Encoder<
    NameValidationAlgParams
> | null = null;
...
export function _encode_NameValidationAlgParams(
    ...
    elGetter: __utils.ASN1Encoder<NameValidationAlgParams>
) {
...
let _cached_decoder_for_CVStatusCode: __utils.ASN1Decoder<
    CVStatusCode
> | null = null;
let _cached_encoder_for_CVStatusCode: __utils.ASN1Encoder<
    CVStatusCode
> | null = null;
export function _decode_CVStatusCode(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CVStatusCode) {
        _cached_decoder_for_CVStatusCode = __utils._decodeEnumerated;
    }
    return _cached_decoder_for_CVStatusCode(el);
}
export function _encode_CVStatusCode(
    value: CVStatusCode,
    elGetter: __utils.ASN1Encoder<CVStatusCode>
) {
    if (!_cached_encoder_for_CVStatusCode) {
        _cached_encoder_for_CVStatusCode = __utils._encodeEnumerated;
    }
...
let _cached_decoder_for_ResponseStatus: __utils.ASN1Decoder<
    ResponseStatus
> | null = null;
let _cached_encoder_for_ResponseStatus: __utils.ASN1Encoder<
    ResponseStatus
> | null = null;
export function _decode_ResponseStatus(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ResponseStatus) {
        _cached_decoder_for_ResponseStatus = function (
            ...
            let statusCode: asn1.OPTIONAL<CVStatusCode> =
                ResponseStatus._default_value_for_statusCode;
            let errorMessage: asn1.OPTIONAL<asn1.UTF8String>;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                statusCode: (_el: asn1.ASN1Element): void => {
                    statusCode = _decode_CVStatusCode(_el);
                },
                errorMessage: (_el: asn1.ASN1Element): void => {
                    errorMessage = __utils._decodeUTF8String(_el);
                },
            };
...
export function _encode_ResponseStatus(
    ...
    elGetter: __utils.ASN1Encoder<ResponseStatus>
) {
...
let _cached_decoder_for_ValidationPolRef: __utils.ASN1Decoder<
    ValidationPolRef
> | null = null;
let _cached_encoder_for_ValidationPolRef: __utils.ASN1Encoder<
    ValidationPolRef
> | null = null;
export function _decode_ValidationPolRef(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ValidationPolRef) {
        _cached_decoder_for_ValidationPolRef = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                valPolId: (_el: asn1.ASN1Element): void => {
                    valPolId = __utils._decodeObjectIdentifier(_el);
                },
                valPolParams: (_el: asn1.ASN1Element): void => {
                    valPolParams = __utils._decodeAny(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export function _encode_ValidationPolRef(
    ...
    elGetter: __utils.ASN1Encoder<ValidationPolRef>
) {
...
let _cached_decoder_for_ValidationAlg: __utils.ASN1Decoder<
    ValidationAlg
> | null = null;
let _cached_encoder_for_ValidationAlg: __utils.ASN1Encoder<
    ValidationAlg
> | null = null;
export function _decode_ValidationAlg(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ValidationAlg) {
        _cached_decoder_for_ValidationAlg = function (
            el: asn1.ASN1Element
        ): ValidationAlg {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                valAlgId: (_el: asn1.ASN1Element): void => {
                    valAlgId = __utils._decodeObjectIdentifier(_el);
                },
...
export function _encode_ValidationAlg(
    value: ValidationAlg,
    elGetter: __utils.ASN1Encoder<ValidationAlg>
) {
...
let _cached_decoder_for_SCVPIssuerSerial: __utils.ASN1Decoder<
    SCVPIssuerSerial
> | null = null;
let _cached_encoder_for_SCVPIssuerSerial: __utils.ASN1Encoder<
    SCVPIssuerSerial
> | null = null;
export function _decode_SCVPIssuerSerial(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SCVPIssuerSerial) {
        _cached_decoder_for_SCVPIssuerSerial = function (
            el: asn1.ASN1Element
        ): SCVPIssuerSerial {
            const sequence: asn1.ASN1Element[] = el.sequence;
            if (sequence.length < 2) {
                throw new asn1.ASN1ConstructionError(
                    "SCVPIssuerSerial contained only " +
                        sequence.length.toString() +
                        " elements."
                );
            }
            ...
            return new SCVPIssuerSerial(issuer, serialNumber);
        };
    }
    return _cached_decoder_for_SCVPIssuerSerial(el);
}
export function _encode_SCVPIssuerSerial(
    value: SCVPIssuerSerial,
    elGetter: __utils.ASN1Encoder<SCVPIssuerSerial>
) {
    if (!_cached_encoder_for_SCVPIssuerSerial) {
        _cached_encoder_for_SCVPIssuerSerial = function (
            value: SCVPIssuerSerial,
            elGetter: __utils.ASN1Encoder<SCVPIssuerSerial>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
...
export class SCVPCertID {
    ...
    public static get _default_value_for_hashAlgorithm() {
        return new AlgorithmIdentifier(id_sha1, undefined);
    }
}
...
let _cached_decoder_for_SCVPCertID: __utils.ASN1Decoder<
    SCVPCertID
> | null = null;
let _cached_encoder_for_SCVPCertID: __utils.ASN1Encoder<
    SCVPCertID
> | null = null;
export function _decode_SCVPCertID(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SCVPCertID) {
        _cached_decoder_for_SCVPCertID = function (
            el: asn1.ASN1Element
        ): SCVPCertID {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_SCVPCertID(
    value: SCVPCertID,
    elGetter: __utils.ASN1Encoder<SCVPCertID>
) {
...
let _cached_decoder_for_PKCReference: __utils.ASN1Decoder<
    PKCReference
> | null = null;
let _cached_encoder_for_PKCReference: __utils.ASN1Encoder<
    PKCReference
> | null = null;
export function _decode_PKCReference(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKCReference) {
        _cached_decoder_for_PKCReference = __utils._decode_inextensible_choice<
            PKCReference
        >({
            "CONTEXT 0": [
                "cert",
                __utils._decode_implicit<Certificate>(
                    () => _decode_Certificate
                ),
            ],
            "CONTEXT 1": [
                "pkcRef",
                __utils._decode_implicit<SCVPCertID>(() => _decode_SCVPCertID),
            ],
        });
    }
...
export function _encode_PKCReference(
    value: PKCReference,
    elGetter: __utils.ASN1Encoder<PKCReference>
) {
    if (!_cached_encoder_for_PKCReference) {
        _cached_encoder_for_PKCReference = __utils._encode_choice<PKCReference>(
            {
                cert: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_Certificate,
                    __utils.BER
                ),
                pkcRef: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_SCVPCertID,
                    __utils.BER
...
let _cached_decoder_for_TrustAnchors: __utils.ASN1Decoder<
    TrustAnchors
> | null = null;
let _cached_encoder_for_TrustAnchors: __utils.ASN1Encoder<
    TrustAnchors
> | null = null;
export function _decode_TrustAnchors(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_TrustAnchors) {
        _cached_decoder_for_TrustAnchors = __utils._decodeSequenceOf<
            PKCReference
...
export function _encode_TrustAnchors(
    value: TrustAnchors,
    elGetter: __utils.ASN1Encoder<TrustAnchors>
) {
    if (!_cached_encoder_for_TrustAnchors) {
        _cached_encoder_for_TrustAnchors = __utils._encodeSequenceOf<
            PKCReference
        >(() => _encode_PKCReference, __utils.BER);
    }
...
let _cached_decoder_for_ValidationPolicy: __utils.ASN1Decoder<
    ValidationPolicy
> | null = null;
let _cached_encoder_for_ValidationPolicy: __utils.ASN1Encoder<
    ValidationPolicy
> | null = null;
export function _decode_ValidationPolicy(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ValidationPolicy) {
        _cached_decoder_for_ValidationPolicy = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                validationPolRef: (_el: asn1.ASN1Element): void => {
                    validationPolRef = _decode_ValidationPolRef(_el);
                },
                validationAlg: (_el: asn1.ASN1Element): void => {
                    validationAlg = __utils._decode_implicit<ValidationAlg>(
                        () => _decode_ValidationAlg
                    )(_el);
                },
                userPolicySet: (_el: asn1.ASN1Element): void => {
                    userPolicySet = __utils._decode_implicit<
                ...
                inhibitPolicyMapping: (_el: asn1.ASN1Element): void => {
                    inhibitPolicyMapping = __utils._decode_implicit<
                        asn1.BOOLEAN
                    >(() => __utils._decodeBoolean)(_el);
                },
                requireExplicitPolicy: (_el: asn1.ASN1Element): void => {
                    requireExplicitPolicy = __utils._decode_implicit<
                        asn1.BOOLEAN
                    >(() => __utils._decodeBoolean)(_el);
                },
                inhibitAnyPolicy: (_el: asn1.ASN1Element): void => {
                    inhibitAnyPolicy = __utils._decode_implicit<asn1.BOOLEAN>(
                        () => __utils._decodeBoolean
                    )(_el);
                },
                trustAnchors: (_el: asn1.ASN1Element): void => {
                    trustAnchors = __utils._decode_implicit<TrustAnchors>(
                        () => _decode_TrustAnchors
                    )(_el);
                },
                keyUsages: (_el: asn1.ASN1Element): void => {
                    keyUsages = __utils._decode_implicit<KeyUsage[]>(() =>
                        __utils._decodeSequenceOf<KeyUsage>(
                            () => _decode_KeyUsage
                        )
                    )(_el);
                },
                extendedKeyUsages: (_el: asn1.ASN1Element): void => {
                    extendedKeyUsages = __utils._decode_implicit<
                        KeyPurposeId[]
                    >(() =>
                        __utils._decodeSequenceOf<KeyPurposeId>(
                            () => _decode_KeyPurposeId
                        )
                    )(_el);
                },
                specifiedKeyUsages: (_el: asn1.ASN1Element): void => {
                    specifiedKeyUsages = __utils._decode_implicit<
                        KeyPurposeId[]
                    >(() =>
                        __utils._decodeSequenceOf<KeyPurposeId>(
                            () => _decode_KeyPurposeId
...
export function _encode_ValidationPolicy(
    ...
    elGetter: __utils.ASN1Encoder<ValidationPolicy>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.validationAlg === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.validationAlg, __utils.BER),
                        /* IF_ABSENT  */ value.userPolicySet === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.userPolicySet, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.inhibitAnyPolicy === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeBoolean,
                                  __utils.BER
                              )(value.inhibitAnyPolicy, __utils.BER),
                        /* IF_ABSENT  */ value.trustAnchors === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.trustAnchors, __utils.BER),
                        /* IF_ABSENT  */ value.keyUsages === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  6,
                                  () =>
                                      __utils._encodeSequenceOf<KeyUsage>(
                                          () => _encode_KeyUsage,
                                          __utils.BER
                                      ),
                                  __utils.BER
                              )(value.keyUsages, __utils.BER),
                        /* IF_ABSENT  */ value.extendedKeyUsages === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  7,
                                  () =>
                                      __utils._encodeSequenceOf<KeyPurposeId>(
                                          () => _encode_KeyPurposeId,
                                          __utils.BER
                                      ),
                                  __utils.BER
                              )(value.extendedKeyUsages, __utils.BER),
                        /* IF_ABSENT  */ value.specifiedKeyUsages === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.specifiedKeyUsages, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_RespValidationPolicy: __utils.ASN1Decoder<
    RespValidationPolicy
> | null = null;
let _cached_encoder_for_RespValidationPolicy: __utils.ASN1Encoder<
    RespValidationPolicy
> | null = null;
...
export function _encode_RespValidationPolicy(
    ...
    elGetter: __utils.ASN1Encoder<RespValidationPolicy>
) {
...
export function _decode_HashValue(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_HashValue) {
        _cached_decoder_for_HashValue = function (
            el: asn1.ASN1Element
        ): HashValue {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let algorithm: asn1.OPTIONAL<HashAlgorithm> =
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                value: (_el: asn1.ASN1Element): void => {
                    value = __utils._decodeOctetString(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export function _encode_HashValue(
    value: HashValue,
    elGetter: __utils.ASN1Encoder<HashValue>
) {
...
let _cached_decoder_for_ACReference: __utils.ASN1Decoder<
    ACReference
> | null = null;
let _cached_encoder_for_ACReference: __utils.ASN1Encoder<
    ACReference
> | null = null;
export function _decode_ACReference(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ACReference) {
        _cached_decoder_for_ACReference = __utils._decode_inextensible_choice<
            ACReference
        >({
            "CONTEXT 2": [
                "attrCert",
...
export function _encode_ACReference(
    value: ACReference,
    elGetter: __utils.ASN1Encoder<ACReference>
) {
    if (!_cached_encoder_for_ACReference) {
        _cached_encoder_for_ACReference = __utils._encode_choice<ACReference>(
            {
                ...
                acRef: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    3,
                    () => _encode_SCVPCertID,
                    __utils.BER
...
let _cached_decoder_for_CertReferences: __utils.ASN1Decoder<
    CertReferences
> | null = null;
let _cached_encoder_for_CertReferences: __utils.ASN1Encoder<
    CertReferences
> | null = null;
export function _decode_CertReferences(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertReferences) {
        _cached_decoder_for_CertReferences = __utils._decode_inextensible_choice<
            CertReferences
        >({
            "CONTEXT 0": [
                "pkcRefs",
                __utils._decode_implicit<PKCReference[]>(() =>
                    __utils._decodeSequenceOf<PKCReference>(
                        () => _decode_PKCReference
                    )
                ),
            ],
            "CONTEXT 1": [
                "acRefs",
                __utils._decode_implicit<ACReference[]>(() =>
                    __utils._decodeSequenceOf<ACReference>(
                        () => _decode_ACReference
                    )
                ),
            ],
...
export function _encode_CertReferences(
    ...
    elGetter: __utils.ASN1Encoder<CertReferences>
) {
    if (!_cached_encoder_for_CertReferences) {
        _cached_encoder_for_CertReferences = __utils._encode_choice<
            CertReferences
        >(
            {
                pkcRefs: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () =>
                        __utils._encodeSequenceOf<PKCReference>(
                            () => _encode_PKCReference,
                            __utils.BER
                        ),
                    __utils.BER
                ),
                acRefs: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () =>
                        __utils._encodeSequenceOf<ACReference>(
                            () => _encode_ACReference,
                            __utils.BER
                        ),
                    __utils.BER
...
let _cached_decoder_for_CertChecks: __utils.ASN1Decoder<
    CertChecks
> | null = null;
let _cached_encoder_for_CertChecks: __utils.ASN1Encoder<
    CertChecks
> | null = null;
export function _decode_CertChecks(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertChecks) {
        _cached_decoder_for_CertChecks = __utils._decodeSequenceOf<
            asn1.OBJECT_IDENTIFIER
        >(() => __utils._decodeObjectIdentifier);
    }
...
export function _encode_CertChecks(
    value: CertChecks,
    elGetter: __utils.ASN1Encoder<CertChecks>
) {
    if (!_cached_encoder_for_CertChecks) {
        _cached_encoder_for_CertChecks = __utils._encodeSequenceOf<
            asn1.OBJECT_IDENTIFIER
...
export function _decode_WantBack(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_WantBack) {
        _cached_decoder_for_WantBack = __utils._decodeSequenceOf<
            asn1.OBJECT_IDENTIFIER
        >(() => __utils._decodeObjectIdentifier);
    }
...
export function _encode_WantBack(
    value: WantBack,
    elGetter: __utils.ASN1Encoder<WantBack>
) {
    if (!_cached_encoder_for_WantBack) {
        _cached_encoder_for_WantBack = __utils._encodeSequenceOf<
            asn1.OBJECT_IDENTIFIER
        >(() => __utils._encodeObjectIdentifier, __utils.BER);
    }
...
let _cached_decoder_for_ResponseFlags: __utils.ASN1Decoder<
    ResponseFlags
> | null = null;
let _cached_encoder_for_ResponseFlags: __utils.ASN1Encoder<
    ResponseFlags
> | null = null;
export function _decode_ResponseFlags(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ResponseFlags) {
        _cached_decoder_for_ResponseFlags = function (
            el: asn1.ASN1Element
        ): ResponseFlags {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let fullRequestInResponse: asn1.OPTIONAL<asn1.BOOLEAN> =
                ResponseFlags._default_value_for_fullRequestInResponse;
            let responseValidationPolByRef: asn1.OPTIONAL<asn1.BOOLEAN> =
                ResponseFlags._default_value_for_responseValidationPolByRef;
            let protectResponse: asn1.OPTIONAL<asn1.BOOLEAN> =
                ResponseFlags._default_value_for_protectResponse;
            let cachedResponse: asn1.OPTIONAL<asn1.BOOLEAN> =
                ResponseFlags._default_value_for_cachedResponse;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                fullRequestInResponse: (_el: asn1.ASN1Element): void => {
                    fullRequestInResponse = __utils._decode_implicit<
                        asn1.BOOLEAN
                    >(() => __utils._decodeBoolean)(_el);
                },
                responseValidationPolByRef: (_el: asn1.ASN1Element): void => {
                    responseValidationPolByRef = __utils._decode_implicit<
                        asn1.BOOLEAN
                    >(() => __utils._decodeBoolean)(_el);
                },
                protectResponse: (_el: asn1.ASN1Element): void => {
                    protectResponse = __utils._decode_implicit<asn1.BOOLEAN>(
                        () => __utils._decodeBoolean
                    )(_el);
                },
                cachedResponse: (_el: asn1.ASN1Element): void => {
                    cachedResponse = __utils._decode_implicit<asn1.BOOLEAN>(
                        () => __utils._decodeBoolean
                    )(_el);
                },
            };
...
export function _encode_ResponseFlags(
    value: ResponseFlags,
    elGetter: __utils.ASN1Encoder<ResponseFlags>
) {
    if (!_cached_encoder_for_ResponseFlags) {
        _cached_encoder_for_ResponseFlags = function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        /* IF_DEFAULT */ value.fullRequestInResponse ===
                            undefined ||
                        __utils.deepEq(
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeBoolean,
                                  __utils.BER
                              )(value.fullRequestInResponse, __utils.BER),
                        /* IF_DEFAULT */ value.responseValidationPolByRef ===
                            undefined ||
                        __utils.deepEq(
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeBoolean,
                                  __utils.BER
                              )(value.responseValidationPolByRef, __utils.BER),
                        ...
                        __utils.deepEq(
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeBoolean,
                                  __utils.BER
                              )(value.protectResponse, __utils.BER),
                        ...
                        __utils.deepEq(
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeBoolean,
                                  __utils.BER
                              )(value.cachedResponse, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_CertBundle: __utils.ASN1Decoder<
    CertBundle
> | null = null;
let _cached_encoder_for_CertBundle: __utils.ASN1Encoder<
    CertBundle
> | null = null;
export function _decode_CertBundle(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertBundle) {
        _cached_decoder_for_CertBundle = __utils._decodeSequenceOf<Certificate>(
            () => _decode_Certificate
        );
    }
...
export function _encode_CertBundle(
    value: CertBundle,
    elGetter: __utils.ASN1Encoder<CertBundle>
) {
    if (!_cached_encoder_for_CertBundle) {
        _cached_encoder_for_CertBundle = __utils._encodeSequenceOf<Certificate>(
            () => _encode_Certificate,
            __utils.BER
        );
    }
...
let _cached_decoder_for_OtherRevInfo: __utils.ASN1Decoder<
    OtherRevInfo
> | null = null;
let _cached_encoder_for_OtherRevInfo: __utils.ASN1Encoder<
    OtherRevInfo
> | null = null;
export function _decode_OtherRevInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_OtherRevInfo) {
        _cached_decoder_for_OtherRevInfo = function (
            el: asn1.ASN1Element
        ): OtherRevInfo {
            const sequence: asn1.ASN1Element[] = el.sequence;
            if (sequence.length < 2) {
...
export function _encode_OtherRevInfo(
    value: OtherRevInfo,
    elGetter: __utils.ASN1Encoder<OtherRevInfo>
) {
...
let _cached_decoder_for_RevocationInfo: __utils.ASN1Decoder<
    RevocationInfo
> | null = null;
let _cached_encoder_for_RevocationInfo: __utils.ASN1Encoder<
    RevocationInfo
> | null = null;
export function _decode_RevocationInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevocationInfo) {
        _cached_decoder_for_RevocationInfo = __utils._decode_inextensible_choice<
            RevocationInfo
        >({
            "CONTEXT 0": [
                "crl",
                __utils._decode_implicit<CertificateList>(
                    () => _decode_CertificateList
                ),
            ],
            "CONTEXT 1": [
            ...
            "CONTEXT 2": [
                "ocsp",
                __utils._decode_implicit<OCSPResponse>(
                    () => _decode_OCSPResponse
                ),
            ],
            "CONTEXT 3": [
                "other",
                __utils._decode_implicit<OtherRevInfo>(
...
export function _encode_RevocationInfo(
    ...
    elGetter: __utils.ASN1Encoder<RevocationInfo>
) {
    if (!_cached_encoder_for_RevocationInfo) {
        _cached_encoder_for_RevocationInfo = __utils._encode_choice<
            RevocationInfo
        >(
            {
                crl: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_CertificateList,
                    __utils.BER
                ),
                delta_crl: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_CertificateList,
                    __utils.BER
                ),
                ocsp: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    2,
                    () => _encode_OCSPResponse,
                    __utils.BER
...
let _cached_decoder_for_RevocationInfos: __utils.ASN1Decoder<
    RevocationInfos
> | null = null;
let _cached_encoder_for_RevocationInfos: __utils.ASN1Encoder<
    RevocationInfos
> | null = null;
export function _decode_RevocationInfos(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevocationInfos) {
        _cached_decoder_for_RevocationInfos = __utils._decodeSequenceOf<
            RevocationInfo
...
export function _encode_RevocationInfos(
    ...
    elGetter: __utils.ASN1Encoder<RevocationInfos>
) {
    if (!_cached_encoder_for_RevocationInfos) {
        _cached_encoder_for_RevocationInfos = __utils._encodeSequenceOf<
            RevocationInfo
        >(() => _encode_RevocationInfo, __utils.BER);
    }
...
export function _decode_Query(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Query) {
        _cached_decoder_for_Query = function (el: asn1.ASN1Element): Query {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                queriedCerts: (_el: asn1.ASN1Element): void => {
                    queriedCerts = _decode_CertReferences(_el);
                },
                checks: (_el: asn1.ASN1Element): void => {
                    checks = _decode_CertChecks(_el);
                },
                wantBack: (_el: asn1.ASN1Element): void => {
                    wantBack = __utils._decode_implicit<WantBack>(
                        () => _decode_WantBack
                    )(_el);
                },
                validationPolicy: (_el: asn1.ASN1Element): void => {
                    validationPolicy = _decode_ValidationPolicy(_el);
                },
                responseFlags: (_el: asn1.ASN1Element): void => {
                    responseFlags = _decode_ResponseFlags(_el);
                },
                serverContextInfo: (_el: asn1.ASN1Element): void => {
                    serverContextInfo = __utils._decode_implicit<
                        asn1.OCTET_STRING
                    >(() => __utils._decodeOctetString)(_el);
                },
                validationTime: (_el: asn1.ASN1Element): void => {
                    validationTime = __utils._decode_implicit<
                        asn1.GeneralizedTime
                    >(() => __utils._decodeGeneralizedTime)(_el);
                },
                intermediateCerts: (_el: asn1.ASN1Element): void => {
                    intermediateCerts = __utils._decode_implicit<CertBundle>(
                        () => _decode_CertBundle
                    )(_el);
                },
                revInfos: (_el: asn1.ASN1Element): void => {
                    revInfos = __utils._decode_implicit<RevocationInfos>(
                        () => _decode_RevocationInfos
                    )(_el);
                },
                producedAt: (_el: asn1.ASN1Element): void => {
                    producedAt = __utils._decode_implicit<asn1.GeneralizedTime>(
                        () => __utils._decodeGeneralizedTime
                    )(_el);
                },
                queryExtensions: (_el: asn1.ASN1Element): void => {
                    queryExtensions = __utils._decode_implicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
            };
...
export function _encode_Query(
    value: Query,
    elGetter: __utils.ASN1Encoder<Query>
) {
    if (!_cached_encoder_for_Query) {
        _cached_encoder_for_Query = function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        /* REQUIRED   */ _encode_CertReferences(
                            value.queriedCerts,
                            __utils.BER
                        ),
                        /* REQUIRED   */ _encode_CertChecks(
                            value.checks,
                            __utils.BER
                        ),
                        ...
                        /* IF_ABSENT  */ value.serverContextInfo === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.serverContextInfo, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.intermediateCerts === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_CertBundle,
                                  __utils.BER
                              )(value.intermediateCerts, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.queryExtensions === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.queryExtensions, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
export function _decode_CVRequest(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CVRequest) {
        _cached_decoder_for_CVRequest = function (
            el: asn1.ASN1Element
        ): CVRequest {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let cvRequestVersion: asn1.OPTIONAL<asn1.INTEGER> =
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                cvRequestVersion: (_el: asn1.ASN1Element): void => {
                    cvRequestVersion = __utils._decodeInteger(_el);
                },
                query: (_el: asn1.ASN1Element): void => {
                    query = _decode_Query(_el);
                },
                requestorRef: (_el: asn1.ASN1Element): void => {
                    requestorRef = __utils._decode_implicit<GeneralNames>(
                        () => _decode_GeneralNames
                    )(_el);
                },
                requestNonce: (_el: asn1.ASN1Element): void => {
                    requestNonce = __utils._decode_implicit<asn1.OCTET_STRING>(
                        () => __utils._decodeOctetString
                    )(_el);
                },
                requestorName: (_el: asn1.ASN1Element): void => {
                    requestorName = __utils._decode_implicit<GeneralName>(
                        () => _decode_GeneralName
                    )(_el);
                },
                responderName: (_el: asn1.ASN1Element): void => {
                    responderName = __utils._decode_implicit<GeneralName>(
                        () => _decode_GeneralName
                    )(_el);
                },
                requestExtensions: (_el: asn1.ASN1Element): void => {
                    requestExtensions = __utils._decode_implicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
                signatureAlg: (_el: asn1.ASN1Element): void => {
                    signatureAlg = __utils._decode_implicit<
                        AlgorithmIdentifier
                    >(() => _decode_AlgorithmIdentifier)(_el);
                },
                hashAlg: (_el: asn1.ASN1Element): void => {
                    hashAlg = __utils._decode_implicit<asn1.OBJECT_IDENTIFIER>(
                        () => __utils._decodeObjectIdentifier
                    )(_el);
                },
                requestorText: (_el: asn1.ASN1Element): void => {
                    requestorText = __utils._decode_implicit<asn1.UTF8String>(
...
export function _encode_CVRequest(
    value: CVRequest,
    elGetter: __utils.ASN1Encoder<CVRequest>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.requestorRef === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_GeneralNames,
                                  __utils.BER
                              )(value.requestorRef, __utils.BER),
                        /* IF_ABSENT  */ value.requestNonce === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeOctetString,
                                  __utils.BER
                              )(value.requestNonce, __utils.BER),
                        /* IF_ABSENT  */ value.requestorName === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_GeneralName,
                                  __utils.BER
                              )(value.requestorName, __utils.BER),
                        /* IF_ABSENT  */ value.responderName === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_GeneralName,
                                  __utils.BER
                              )(value.responderName, __utils.BER),
                        /* IF_ABSENT  */ value.requestExtensions === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.requestExtensions, __utils.BER),
                        /* IF_ABSENT  */ value.signatureAlg === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_AlgorithmIdentifier,
                                  __utils.BER
                              )(value.signatureAlg, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.requestorText === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => __utils._encodeUTF8String,
                                  __utils.BER
                              )(value.requestorText, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_RequestReference: __utils.ASN1Decoder<
    RequestReference
> | null = null;
let _cached_encoder_for_RequestReference: __utils.ASN1Encoder<
    RequestReference
> | null = null;
export function _decode_RequestReference(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RequestReference) {
        _cached_decoder_for_RequestReference = __utils._decode_inextensible_choice<
            RequestReference
        >({
            "CONTEXT 0": [
                "requestHash",
                __utils._decode_implicit<HashValue>(() => _decode_HashValue),
            ],
            "CONTEXT 1": [
                "fullRequest",
                __utils._decode_implicit<CVRequest>(() => _decode_CVRequest),
            ],
        });
    }
...
export function _encode_RequestReference(
    ...
    elGetter: __utils.ASN1Encoder<RequestReference>
) {
    if (!_cached_encoder_for_RequestReference) {
        _cached_encoder_for_RequestReference = __utils._encode_choice<
            RequestReference
        >(
            {
                requestHash: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_HashValue,
                    __utils.BER
                ),
                fullRequest: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_CVRequest,
                    __utils.BER
...
let _cached_decoder_for_CertReference: __utils.ASN1Decoder<
    CertReference
> | null = null;
let _cached_encoder_for_CertReference: __utils.ASN1Encoder<
    CertReference
> | null = null;
export function _decode_CertReference(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertReference) {
        _cached_decoder_for_CertReference = __utils._decode_inextensible_choice<
            CertReference
        >({
...
export function _encode_CertReference(
    value: CertReference,
    elGetter: __utils.ASN1Encoder<CertReference>
) {
    if (!_cached_encoder_for_CertReference) {
        _cached_encoder_for_CertReference = __utils._encode_choice<
            CertReference
        >(
            {
...
let _cached_decoder_for_ReplyStatus: __utils.ASN1Decoder<
    ReplyStatus
> | null = null;
let _cached_encoder_for_ReplyStatus: __utils.ASN1Encoder<
    ReplyStatus
> | null = null;
export function _decode_ReplyStatus(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyStatus) {
        _cached_decoder_for_ReplyStatus = __utils._decodeEnumerated;
    }
    return _cached_decoder_for_ReplyStatus(el);
}
export function _encode_ReplyStatus(
    value: ReplyStatus,
    elGetter: __utils.ASN1Encoder<ReplyStatus>
) {
    if (!_cached_encoder_for_ReplyStatus) {
        _cached_encoder_for_ReplyStatus = __utils._encodeEnumerated;
    }
...
let _cached_decoder_for_ReplyCheck: __utils.ASN1Decoder<
    ReplyCheck
> | null = null;
let _cached_encoder_for_ReplyCheck: __utils.ASN1Encoder<
    ReplyCheck
> | null = null;
export function _decode_ReplyCheck(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyCheck) {
        _cached_decoder_for_ReplyCheck = function (
            el: asn1.ASN1Element
        ): ReplyCheck {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let check!: asn1.OBJECT_IDENTIFIER;
            let status: asn1.OPTIONAL<asn1.INTEGER> =
                ReplyCheck._default_value_for_status;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                check: (_el: asn1.ASN1Element): void => {
                    check = __utils._decodeObjectIdentifier(_el);
                },
                status: (_el: asn1.ASN1Element): void => {
                    status = __utils._decodeInteger(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export function _encode_ReplyCheck(
    value: ReplyCheck,
    elGetter: __utils.ASN1Encoder<ReplyCheck>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        __utils.deepEq(
                            ...
                            ? undefined
                            : __utils._encodeInteger(value.status, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_ReplyChecks: __utils.ASN1Decoder<
    ReplyChecks
> | null = null;
let _cached_encoder_for_ReplyChecks: __utils.ASN1Encoder<
    ReplyChecks
> | null = null;
export function _decode_ReplyChecks(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyChecks) {
        _cached_decoder_for_ReplyChecks = __utils._decodeSequenceOf<ReplyCheck>(
            () => _decode_ReplyCheck
        );
    }
...
export function _encode_ReplyChecks(
    value: ReplyChecks,
    elGetter: __utils.ASN1Encoder<ReplyChecks>
) {
    if (!_cached_encoder_for_ReplyChecks) {
        _cached_encoder_for_ReplyChecks = __utils._encodeSequenceOf<ReplyCheck>(
            () => _encode_ReplyCheck,
            __utils.BER
        );
    }
...
let _cached_decoder_for_ReplyWantBack: __utils.ASN1Decoder<
    ReplyWantBack
> | null = null;
let _cached_encoder_for_ReplyWantBack: __utils.ASN1Encoder<
    ReplyWantBack
> | null = null;
export function _decode_ReplyWantBack(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyWantBack) {
        _cached_decoder_for_ReplyWantBack = function (
            el: asn1.ASN1Element
        ): ReplyWantBack {
            const sequence: asn1.ASN1Element[] = el.sequence;
            if (sequence.length < 2) {
...
export function _encode_ReplyWantBack(
    value: ReplyWantBack,
    elGetter: __utils.ASN1Encoder<ReplyWantBack>
) {
...
let _cached_decoder_for_ReplyWantBacks: __utils.ASN1Decoder<
    ReplyWantBacks
> | null = null;
let _cached_encoder_for_ReplyWantBacks: __utils.ASN1Encoder<
    ReplyWantBacks
> | null = null;
export function _decode_ReplyWantBacks(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyWantBacks) {
        _cached_decoder_for_ReplyWantBacks = __utils._decodeSequenceOf<
            ReplyWantBack
...
export function _encode_ReplyWantBacks(
    ...
    elGetter: __utils.ASN1Encoder<ReplyWantBacks>
) {
    if (!_cached_encoder_for_ReplyWantBacks) {
        _cached_encoder_for_ReplyWantBacks = __utils._encodeSequenceOf<
            ReplyWantBack
        >(() => _encode_ReplyWantBack, __utils.BER);
    }
...
export function _decode_CertReply(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertReply) {
        _cached_decoder_for_CertReply = function (
            el: asn1.ASN1Element
        ): CertReply {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let cert!: CertReference;
            let replyStatus: asn1.OPTIONAL<ReplyStatus> =
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                replyStatus: (_el: asn1.ASN1Element): void => {
                    replyStatus = _decode_ReplyStatus(_el);
                },
                replyValTime: (_el: asn1.ASN1Element): void => {
                    replyValTime = __utils._decodeGeneralizedTime(_el);
                },
                replyChecks: (_el: asn1.ASN1Element): void => {
                    replyChecks = _decode_ReplyChecks(_el);
                },
                replyWantBacks: (_el: asn1.ASN1Element): void => {
                    replyWantBacks = _decode_ReplyWantBacks(_el);
                },
                validationErrors: (_el: asn1.ASN1Element): void => {
                    validationErrors = __utils._decode_implicit<
                        asn1.OBJECT_IDENTIFIER[]
                    >(() =>
                        __utils._decodeSequenceOf<asn1.OBJECT_IDENTIFIER>(
                            () => __utils._decodeObjectIdentifier
                ...
                nextUpdate: (_el: asn1.ASN1Element): void => {
                    nextUpdate = __utils._decode_implicit<asn1.GeneralizedTime>(
                        () => __utils._decodeGeneralizedTime
                    )(_el);
                },
                certReplyExtensions: (_el: asn1.ASN1Element): void => {
                    certReplyExtensions = __utils._decode_implicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
            };
...
export function _encode_CertReply(
    value: CertReply,
    elGetter: __utils.ASN1Encoder<CertReply>
) {
    if (!_cached_encoder_for_CertReply) {
        _cached_encoder_for_CertReply = function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        /* REQUIRED   */ _encode_CertReference(
                            value.cert,
                            __utils.BER
                        ),
                        ...
                        /* IF_ABSENT  */ value.validationErrors === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.validationErrors, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.certReplyExtensions === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.certReplyExtensions, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_ReplyObjects: __utils.ASN1Decoder<
    ReplyObjects
> | null = null;
let _cached_encoder_for_ReplyObjects: __utils.ASN1Encoder<
    ReplyObjects
> | null = null;
export function _decode_ReplyObjects(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReplyObjects) {
        _cached_decoder_for_ReplyObjects = __utils._decodeSequenceOf<CertReply>(
            () => _decode_CertReply
        );
    }
...
export function _encode_ReplyObjects(
    value: ReplyObjects,
    elGetter: __utils.ASN1Encoder<ReplyObjects>
) {
    if (!_cached_encoder_for_ReplyObjects) {
        _cached_encoder_for_ReplyObjects = __utils._encodeSequenceOf<CertReply>(
            () => _encode_CertReply,
            __utils.BER
        );
    }
...
let _cached_decoder_for_CVResponse: __utils.ASN1Decoder<
    CVResponse
> | null = null;
let _cached_encoder_for_CVResponse: __utils.ASN1Encoder<
    CVResponse
> | null = null;
export function _decode_CVResponse(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CVResponse) {
        _cached_decoder_for_CVResponse = function (
            el: asn1.ASN1Element
        ): CVResponse {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                cvResponseVersion: (_el: asn1.ASN1Element): void => {
                    cvResponseVersion = __utils._decodeInteger(_el);
                },
                serverConfigurationID: (_el: asn1.ASN1Element): void => {
                    serverConfigurationID = __utils._decodeInteger(_el);
                },
                producedAt: (_el: asn1.ASN1Element): void => {
                    producedAt = __utils._decodeGeneralizedTime(_el);
                },
                responseStatus: (_el: asn1.ASN1Element): void => {
                    responseStatus = _decode_ResponseStatus(_el);
                },
                respValidationPolicy: (_el: asn1.ASN1Element): void => {
                    respValidationPolicy = __utils._decode_implicit<
                        RespValidationPolicy
                    >(() => _decode_RespValidationPolicy)(_el);
                },
                requestRef: (_el: asn1.ASN1Element): void => {
                    requestRef = __utils._decode_implicit<RequestReference>(
                ...
                requestorName: (_el: asn1.ASN1Element): void => {
                    requestorName = __utils._decode_implicit<GeneralNames>(
                        () => _decode_GeneralNames
                    )(_el);
                },
                replyObjects: (_el: asn1.ASN1Element): void => {
                    replyObjects = __utils._decode_implicit<ReplyObjects>(
                        () => _decode_ReplyObjects
                    )(_el);
                },
                respNonce: (_el: asn1.ASN1Element): void => {
                    respNonce = __utils._decode_implicit<asn1.OCTET_STRING>(
                        () => __utils._decodeOctetString
                    )(_el);
                },
                serverContextInfo: (_el: asn1.ASN1Element): void => {
                ...
                cvResponseExtensions: (_el: asn1.ASN1Element): void => {
                    cvResponseExtensions = __utils._decode_implicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
                requestorText: (_el: asn1.ASN1Element): void => {
...
export function _encode_CVResponse(
    value: CVResponse,
    elGetter: __utils.ASN1Encoder<CVResponse>
) {
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.respValidationPolicy ===
                        undefined
                            ? undefined
                            : __utils._encode_implicit(
                                  asn1.ASN1TagClass.context,
                                  ...
                                  __utils.BER
                              )(value.respValidationPolicy, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.replyObjects === undefined
                            ...
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.replyObjects, __utils.BER),
                        ...
                        /* IF_ABSENT  */ value.cvResponseExtensions ===
                        undefined
                            ? undefined
                            : __utils._encode_implicit(
                                  asn1.ASN1TagClass.context,
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.cvResponseExtensions, __utils.BER),
                        /* IF_ABSENT  */ value.requestorText === undefined
                            ? undefined
                            : __utils._encode_implicit(
                                  asn1.ASN1TagClass.context,
...
let _cached_decoder_for_CertBundles: __utils.ASN1Decoder<
    CertBundles
> | null = null;
let _cached_encoder_for_CertBundles: __utils.ASN1Encoder<
    CertBundles
> | null = null;
export function _decode_CertBundles(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertBundles) {
        _cached_decoder_for_CertBundles = __utils._decodeSequenceOf<CertBundle>(
            () => _decode_CertBundle
        );
    }
...
export function _encode_CertBundles(
    value: CertBundles,
    elGetter: __utils.ASN1Encoder<CertBundles>
) {
    if (!_cached_encoder_for_CertBundles) {
        _cached_encoder_for_CertBundles = __utils._encodeSequenceOf<CertBundle>(
            () => _encode_CertBundle,
            __utils.BER
        );
    }
...
let _cached_decoder_for_RevInfoWantBack: __utils.ASN1Decoder<
    RevInfoWantBack
> | null = null;
let _cached_encoder_for_RevInfoWantBack: __utils.ASN1Encoder<
    RevInfoWantBack
> | null = null;
export function _decode_RevInfoWantBack(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevInfoWantBack) {
        _cached_decoder_for_RevInfoWantBack = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                revocationInfo: (_el: asn1.ASN1Element): void => {
...
export function _encode_RevInfoWantBack(
    ...
    elGetter: __utils.ASN1Encoder<RevInfoWantBack>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.extraCerts === undefined
                            ? undefined
                            : _encode_CertBundle(value.extraCerts, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_SCVPResponses: __utils.ASN1Decoder<
    SCVPResponses
> | null = null;
let _cached_encoder_for_SCVPResponses: __utils.ASN1Encoder<
    SCVPResponses
> | null = null;
export function _decode_SCVPResponses(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SCVPResponses) {
        _cached_decoder_for_SCVPResponses = __utils._decodeSequenceOf<
            ContentInfo
        >(() => _decode_ContentInfo);
    }
...
export function _encode_SCVPResponses(
    value: SCVPResponses,
    elGetter: __utils.ASN1Encoder<SCVPResponses>
) {
    if (!_cached_encoder_for_SCVPResponses) {
        _cached_encoder_for_SCVPResponses = __utils._encodeSequenceOf<
            ContentInfo
...
let _cached_decoder_for_ValPolRequest: __utils.ASN1Decoder<
    ValPolRequest
> | null = null;
let _cached_encoder_for_ValPolRequest: __utils.ASN1Encoder<
    ValPolRequest
> | null = null;
export function _decode_ValPolRequest(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ValPolRequest) {
        _cached_decoder_for_ValPolRequest = function (
            el: asn1.ASN1Element
        ): ValPolRequest {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let vpRequestVersion: asn1.OPTIONAL<asn1.INTEGER> =
                ValPolRequest._default_value_for_vpRequestVersion;
            let requestNonce!: asn1.OCTET_STRING;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                vpRequestVersion: (_el: asn1.ASN1Element): void => {
                    vpRequestVersion = __utils._decodeInteger(_el);
                },
                requestNonce: (_el: asn1.ASN1Element): void => {
                    requestNonce = __utils._decodeOctetString(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export function _encode_ValPolRequest(
    value: ValPolRequest,
    elGetter: __utils.ASN1Encoder<ValPolRequest>
) {
...
let _cached_decoder_for_AuthPolicy: __utils.ASN1Decoder<
    AuthPolicy
> | null = null;
let _cached_encoder_for_AuthPolicy: __utils.ASN1Encoder<
    AuthPolicy
> | null = null;
export function _decode_AuthPolicy(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_AuthPolicy) {
        _cached_decoder_for_AuthPolicy = __utils._decodeObjectIdentifier;
    }
    return _cached_decoder_for_AuthPolicy(el);
}
export function _encode_AuthPolicy(
    value: AuthPolicy,
    elGetter: __utils.ASN1Encoder<AuthPolicy>
) {
    if (!_cached_encoder_for_AuthPolicy) {
        _cached_encoder_for_AuthPolicy = __utils._encodeObjectIdentifier;
    }
...
let _cached_decoder_for_ResponseTypes: __utils.ASN1Decoder<
    ResponseTypes
> | null = null;
let _cached_encoder_for_ResponseTypes: __utils.ASN1Encoder<
    ResponseTypes
> | null = null;
export function _decode_ResponseTypes(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ResponseTypes) {
        _cached_decoder_for_ResponseTypes = __utils._decodeEnumerated;
    }
    return _cached_decoder_for_ResponseTypes(el);
}
export function _encode_ResponseTypes(
    value: ResponseTypes,
    elGetter: __utils.ASN1Encoder<ResponseTypes>
) {
    if (!_cached_encoder_for_ResponseTypes) {
        _cached_encoder_for_ResponseTypes = __utils._encodeEnumerated;
    }
...
let _cached_decoder_for_RevocationInfoTypes: __utils.ASN1Decoder<
    RevocationInfoTypes
> | null = null;
let _cached_encoder_for_RevocationInfoTypes: __utils.ASN1Encoder<
    RevocationInfoTypes
> | null = null;
export function _decode_RevocationInfoTypes(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevocationInfoTypes) {
        _cached_decoder_for_RevocationInfoTypes = __utils._decodeBitString;
    }
    return _cached_decoder_for_RevocationInfoTypes(el);
}
export function _encode_RevocationInfoTypes(
    value: RevocationInfoTypes,
    elGetter: __utils.ASN1Encoder<RevocationInfoTypes>
) {
    if (!_cached_encoder_for_RevocationInfoTypes) {
        _cached_encoder_for_RevocationInfoTypes = __utils._encodeBitString;
    }
...
let _cached_decoder_for_KeyAgreePublicKey: __utils.ASN1Decoder<
    KeyAgreePublicKey
> | null = null;
let _cached_encoder_for_KeyAgreePublicKey: __utils.ASN1Encoder<
    KeyAgreePublicKey
> | null = null;
...
export function _encode_KeyAgreePublicKey(
    ...
    elGetter: __utils.ASN1Encoder<KeyAgreePublicKey>
) {
...
let _cached_decoder_for_ValPolResponse: __utils.ASN1Decoder<
    ValPolResponse
> | null = null;
let _cached_encoder_for_ValPolResponse: __utils.ASN1Encoder<
    ValPolResponse
> | null = null;
export function _decode_ValPolResponse(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ValPolResponse) {
        _cached_decoder_for_ValPolResponse = function (
            ...
            let clockSkew: asn1.OPTIONAL<asn1.INTEGER> =
                ValPolResponse._default_value_for_clockSkew;
            let requestNonce: asn1.OPTIONAL<asn1.OCTET_STRING>;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                vpResponseVersion: (_el: asn1.ASN1Element): void => {
                    vpResponseVersion = __utils._decodeInteger(_el);
                },
                maxCVRequestVersion: (_el: asn1.ASN1Element): void => {
                    maxCVRequestVersion = __utils._decodeInteger(_el);
                },
                maxVPRequestVersion: (_el: asn1.ASN1Element): void => {
                    maxVPRequestVersion = __utils._decodeInteger(_el);
                },
                serverConfigurationID: (_el: asn1.ASN1Element): void => {
                    serverConfigurationID = __utils._decodeInteger(_el);
                },
                thisUpdate: (_el: asn1.ASN1Element): void => {
                    thisUpdate = __utils._decodeGeneralizedTime(_el);
                },
                nextUpdate: (_el: asn1.ASN1Element): void => {
                    nextUpdate = __utils._decodeGeneralizedTime(_el);
                },
                supportedChecks: (_el: asn1.ASN1Element): void => {
                    supportedChecks = _decode_CertChecks(_el);
                },
                supportedWantBacks: (_el: asn1.ASN1Element): void => {
                    supportedWantBacks = _decode_WantBack(_el);
                },
                validationPolicies: (_el: asn1.ASN1Element): void => {
                    validationPolicies = __utils._decodeSequenceOf<
                        asn1.OBJECT_IDENTIFIER
                    >(() => __utils._decodeObjectIdentifier)(_el);
                },
                validationAlgs: (_el: asn1.ASN1Element): void => {
                    validationAlgs = __utils._decodeSequenceOf<
                        asn1.OBJECT_IDENTIFIER
                    >(() => __utils._decodeObjectIdentifier)(_el);
                },
                authPolicies: (_el: asn1.ASN1Element): void => {
                    authPolicies = __utils._decodeSequenceOf<AuthPolicy>(
                        () => _decode_AuthPolicy
                    )(_el);
                },
                responseTypes: (_el: asn1.ASN1Element): void => {
                    responseTypes = _decode_ResponseTypes(_el);
                },
                defaultPolicyValues: (_el: asn1.ASN1Element): void => {
                    defaultPolicyValues = _decode_RespValidationPolicy(_el);
                },
                revocationInfoTypes: (_el: asn1.ASN1Element): void => {
                    revocationInfoTypes = _decode_RevocationInfoTypes(_el);
                },
                signatureGeneration: (_el: asn1.ASN1Element): void => {
                    signatureGeneration = __utils._decodeSequenceOf<
                        AlgorithmIdentifier
                    >(() => _decode_AlgorithmIdentifier)(_el);
                },
                signatureVerification: (_el: asn1.ASN1Element): void => {
                    signatureVerification = __utils._decodeSequenceOf<
                        AlgorithmIdentifier
                    >(() => _decode_AlgorithmIdentifier)(_el);
                },
                hashAlgorithms: (_el: asn1.ASN1Element): void => {
                    hashAlgorithms = __utils._decodeSequenceOf<
                        asn1.OBJECT_IDENTIFIER
                    >(() => __utils._decodeObjectIdentifier)(_el);
                },
                serverPublicKeys: (_el: asn1.ASN1Element): void => {
                    serverPublicKeys = __utils._decodeSequenceOf<
                        KeyAgreePublicKey
                    >(() => _decode_KeyAgreePublicKey)(_el);
                },
                clockSkew: (_el: asn1.ASN1Element): void => {
                    clockSkew = __utils._decodeInteger(_el);
                },
                requestNonce: (_el: asn1.ASN1Element): void => {
                    requestNonce = __utils._decodeOctetString(_el);
                },
...
export function _encode_ValPolResponse(
    ...
    elGetter: __utils.ASN1Encoder<ValPolResponse>
) {
        ...
        _cached_encoder_for_ValPolResponse = function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        /* REQUIRED   */ __utils._encodeInteger(
                            value.vpResponseVersion,
                            __utils.BER
                        ),
                        /* REQUIRED   */ __utils._encodeInteger(
                            value.maxCVRequestVersion,
                            __utils.BER
                        ),
                        /* REQUIRED   */ __utils._encodeInteger(
                            value.maxVPRequestVersion,
                            __utils.BER
                        ),
                        /* REQUIRED   */ __utils._encodeInteger(
                            value.serverConfigurationID,
                        ...
                        /* REQUIRED   */ _encode_CertChecks(
                            value.supportedChecks,
                            __utils.BER
                        ),
                        /* REQUIRED   */ _encode_WantBack(
                            value.supportedWantBacks,
                            __utils.BER
                        ),
                        ...
                        /* REQUIRED   */ __utils._encodeSequenceOf<
                            asn1.OBJECT_IDENTIFIER
                        >(() => __utils._encodeObjectIdentifier, __utils.BER)(
                            value.validationAlgs,
                            __utils.BER
                        ),
                        /* REQUIRED   */ __utils._encodeSequenceOf<AuthPolicy>(
                            () => _encode_AuthPolicy,
                            __utils.BER
                        )(value.authPolicies, __utils.BER),
                        /* REQUIRED   */ _encode_ResponseTypes(
                            value.responseTypes,
                            __utils.BER
                        ),
                        ...
                        /* IF_ABSENT  */ value.serverPublicKeys === undefined
                            ? undefined
                            : __utils._encodeSequenceOf<KeyAgreePublicKey>(
                                  () => _encode_KeyAgreePublicKey,
                                  __utils.BER
                              )(value.serverPublicKeys, __utils.BER),
